<?php session_start();
	  ...
	  $title = "Izmeni komentare | Administracija | " . $site_name;
?>
...
<script type="text/JavaScript">
	...
	function prikazi_proizvode(){
		...
		if (httpObject != null) {
			httpObject.open("GET", "ajax.php?izmena_komentara=" +document.getElementById('tip_proizvoda').value+ "&naziv=" +document.getElementById('naziv_proizvoda').value, true);
...
<div id="main_container">
   ...
   <div class="center_content">
		<div class="center_title_bar">Izmeni / Izbrisi komentare proizvoda</div>
		...
		<div id="ispisi_proizvode">
			<?php
				...
				if(isset($id_podkategorije)){
					...
					$upit_proizvodi="SELECT id_proizvoda, id_podkategorije, naziv_proizvoda, cena_proizvoda, slika_proizvoda, nova_cena FROM proizvodi $condition AND naziv_proizvoda LIKE '%$naziv_proizvoda%' LIMIT $rowsperpage OFFSET $offset";
