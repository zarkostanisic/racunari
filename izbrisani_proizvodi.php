<?php session_start();
    ...
    $title = "Izbrisani proizvodi | Administracija | " . $site_name;
?>
...
<script type="text/JavaScript">
  ...
  function prikazi_proizvode(){
    ...
    if (httpObject != null) {
      httpObject.open("GET", "ajax.php?izbrisani=" +document.getElementById('tip_proizvoda').value+ "&naziv=" +document.getElementById('naziv_proizvoda').value, true);
...
<div id="main_container">
  ...
  <div id="header">
   ...
   <div class="center_content">
    <div class="center_title_bar">Izbrisani proizvodi</div>
    ...
    <?php
      if(isset($_GET['id'])){//brisanje proizvoda
        ...
        $upit_brisanje="UPDATE proizvodi SET status='1' WHERE id_proizvoda='$id'";
        $rezultat_brisanje=mysql_query($upit_brisanje,$konekcija);

        if($rezultat_brisanje){
          echo "<div class='komentar' style='margin-left:70px;text-align:center;'>Proizvod će ponovo biti prikazan</div>";
        }else{
