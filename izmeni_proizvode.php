<?php session_start();
	  ...
	  $title = "Izmeni proizvode | Administracija | " . $site_name;
?>
...
<script type="text/JavaScript">
	...
	function prikazi_proizvode(){
		...
		if (httpObject != null) {
			httpObject.open("GET", "ajax.php?id_podkategorije=" +document.getElementById('tip_proizvoda').value+ "&naziv=" +document.getElementById('naziv_proizvoda').value, true);
...
<div id="main_container">
   ...
   <div class="center_content">
		<div class="center_title_bar">Izmeni proizvode</div>
			...
			<td class='prva_kolona'>
				...
				<select  name="tip_proizvoda" id="tip_proizvoda" class='select'>
					...
					<?php
						...
						$upit_tip="SELECT * FROM podkategorije WHERE status='1' ORDER BY naziv_podkategorije";
