...
<script type="text/JavaScript">
	...
	function prikazi_proizvode(){
		...
		if (httpObject != null) {
			httpObject.open("GET", "ajax.php?akcija=" +document.getElementById('tip_proizvoda').value + "&naziv=" +document.getElementById('naziv_proizvoda').value, true);
...
<div id="main_container">
   ...
   <div class="center_content">
		<div class="center_title_bar">Stavi na akciju</div>
